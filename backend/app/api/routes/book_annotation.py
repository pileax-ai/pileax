...
async def save(item_in: BookAnnotationCreate, controller: BookAnnotationController = Depends()) -> Any:
...
async def update(item_in: BookAnnotationUpdate, controller: BookAnnotationController = Depends()) -> Any:
    return controller.update(item_in)


@router.api_delete("")
async def delete(id: UUID, controller: BookAnnotationController = Depends()) -> Any:
...
async def query_details(query: PaginationQuery, controller: BookAnnotationController = Depends()) -> Any:
