...
Revision ID: 556b19f5847e
Revises:
Create Date: 2025-12-05 01:40:07.797544
...
def upgrade() -> None:
    ...
    sa.Column('credential_id', app.api.models.base.UUIDString(length=36), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id'),
