...
Revision ID: 0ec9209bf473
Revises:
Create Date: 2025-12-25 11:55:27.446345
...
def upgrade() -> None:
    ...
    op.create_table('app',
    sa.Column('create_time', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='Created time'),
    sa.Column('update_time', sa.DateTime(), server_default=sa.text('now()'), nullable=False, comment='Updated time'),
    ...
    sa.Column('app_model_config_id', app.api.models.base.GUID(), nullable=False),
    ...
    sa.Column('workspace_id', app.api.models.base.GUID(), nullable=False),
    sa.Column('user_id', app.api.models.base.GUID(), nullable=False),
    sa.Column('parent', app.api.models.base.GUID(), nullable=False),
    sa.Column('title', sqlmodel.sql.sqltypes.AutoString(length=255), nullable=False),
    sa.Column('icon', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    sa.Column('invited_by', app.api.models.base.GUID(), nullable=False),
    sa.Column('status', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id'),
