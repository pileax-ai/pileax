<template>
  <section class="row col-12 navi-tabbar drag-region"
           :class="`${tabBar.style}`">
    <div class="row col-auto items-center justify-center text-readable navi-left"
          ...
          <q-route-tab :to="item.path" :ripple="false" class="no-drag-region">
            <section class="row items-center item">
              <div class="col-auto row justify-center items-center prefix">
                <o-icon :name="item.icon" size="1.4rem" />
              </div>
              <div class="col ellipsis label">
                {{ menuLabel(item.name) }}
              </div>
              <div class="col-auto row justify-center items-center suffix">
    ...
    <div class="row col-auto items-center justify-center more no-drag-region">
      ...
      <opened-tabs-hover-btn :icon="moreIcon" class="text-readable" round v-else />
    </div>
  </section>
</template>
