export default {
  ...
  categoryInfo: 'Informacje o kategorii',
  chapter: 'Rozdział',
  code: 'Kod',
  ...
  warning: {
    collectionContainBook: 'Nie można usunąć. Do tej kolekcji odwołują się istniejące książki.',
