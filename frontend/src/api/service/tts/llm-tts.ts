...
import { generateTextId, getLLMTTSAudio } from 'src/api/service/tts/utils/tts-util'
 ...
 * @version 1.0
 */
export class LLMTTSClient extends BaseTTSClient {
  ...
  private async fetchAudio(text: string): Promise<ArrayBuffer> {
    ...
    return getLLMTTSAudio(text, this.currentController)
  }
